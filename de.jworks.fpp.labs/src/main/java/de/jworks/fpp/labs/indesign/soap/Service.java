 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://localhost:80/Service.wsdl", wsdlLocation = "http://dtp-server:9086/service?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://localhost:80/Service.wsdl", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://dtp-server:9086/service?wsdl");
    ...
    public ServicePortType getService() {
        return super.getPort(new QName("http://localhost:80/Service.wsdl", "Service"), ServicePortType.class);
    }
    ...
    public ServicePortType getService(WebServiceFeature... features) {
        return super.getPort(new QName("http://localhost:80/Service.wsdl", "Service"), ServicePortType.class, features);
    }
